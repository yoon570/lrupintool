...
VOID APP_THREAD_REPRESENTITVE::ProcessBuffer(VOID* buf, UINT64 numElements, THREADID tid)
{
    ...
    if (ATOMIC::OPS::Load< int >(&numThreadsCalledWaitForAllThreadsStarted) == numThreadsInApp &&
...
void CalledWaitForAllThreadsStarted(THREADID tid) { ATOMIC::OPS::Increment< int >(&numThreadsCalledWaitForAllThreadsStarted, 1); }
